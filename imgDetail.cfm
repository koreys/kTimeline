	...
	<div class="instaImgDiv">
		...
		<div id="profileCol">
		 	...
		 	<div class="likesAndCommentBlock">
		 		<i class="icon-heart text-error"></i>  #imgDetails.data.likes.count# | <i class="icon-comment"></i> #imgDetails.data.comments.count#
				<br>&nbsp;<br>
		...
		<div id="commentsDiv">
			...
			<CFIF isDefined("imgDetails.data.caption.from.full_name")>
				...
				<CFLOOP array="#userNameAr#" index="un">
					<CFSET newCaptionTxt = #REPLACE(#newCaptionTxt#, #un#, "<a href='userfeed.cfm?access_token=#URL.access_token#&userid=#imgDetails.data.user.id#&user=#imgDetails.data.user.full_name#'>" & #un# & "</a>")#>
				</CFLOOP>

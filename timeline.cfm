	...
	<div class="center-block" id="loginBox">
		...
		<CFELSE>
			<center>
				...
				<a class="btn btn-primary" href="https://api.instagram.com/oauth/authorize/?client_id=578b4fc24c07486fae6fae76d398b980&redirect_uri=http://korey.me/Auth.cfm&response_type=code&scope=likes">Click here to get authenticated!!</a>
			</center>
		</CFIF>
	</div><!-- End LoginBox -->
